...
#Intercept:If there a re no rooms, the expected value for fuelbill is -251.9. The intercept is negative which is hard to since fuelbill is meant to be either 0 or positive
```
